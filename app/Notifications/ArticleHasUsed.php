...
class ArticleHasUsed extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                ...
                ->level('success')
                ->subject("Article Used: ".$this->article->title)
                ->greeting('Dear '.$this->user->name)
                ->line('Congratulation Your article #'.$this->article->article_id.' has been used.')
                ->line('Article ID: '.$this->article->article_id)
                ->line('Title: '.$this->article->title)
                ->line('Used With: $'.$this->article->sale_with)
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'message' => 'Your article has been Used!',
        ];
    }
}
