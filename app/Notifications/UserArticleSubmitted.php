...
class UserArticleSubmitted extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                ...
                ->level('info')
                ->subject("Article Submitted: ".$this->article->title)
                ->greeting('Thank you '.$this->user->name)
                ->line('Your article was submit successfully.we will let you know soon.you can see your submitted article details.')
